...
export const Aboutme = () => {
  return (
    <div className="px-8 text-white py-10 relative md:px-14 lg:px-32 xl:px-52">
      <h2 className="font-syne text-2xl font-bold md:text-3xl lg:text-5xl">
        About Me
      </h2>
      <p className="text-[#949494] mt-5 text-sm lg:max-w-[90%] xl:text-lg xl:mt-12 xl:max-w-[82%] 2xl:max-w-[75%]">
      ...
      <img
        src={backquote}
        alt=""
        className="font-extrabold absolute top-3 right-5 w-[80px] md:right-8 md:w-[100px] lg:right-25 lg:w-[150px] xl:w-[180px] xl:right-32"
      />
